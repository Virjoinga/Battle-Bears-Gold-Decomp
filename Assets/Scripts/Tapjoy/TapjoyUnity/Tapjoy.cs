...
namespace TapjoyUnity
{
	public class Tapjoy
	{
		...
		internal const string VERSION_NAME = "11.9.1";
		...
		public static void EnablePaidAppWithActionID(string paidAppWithActionID)
		{
			ApiBinding.Instance.EnablePaidAppWithActionID(paidAppWithActionID);
		}
