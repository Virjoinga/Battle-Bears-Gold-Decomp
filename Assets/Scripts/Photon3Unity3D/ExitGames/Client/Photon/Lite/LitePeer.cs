...
namespace ExitGames.Client.Photon.Lite
{
	public class LitePeer : PhotonPeer
	{
		...
		public virtual bool OpRaiseEvent(byte eventCode, byte interestGroup, System.Collections.Hashtable customEventContent, bool sendReliable)
		{
			Dictionary<byte, object> dictionary = new Dictionary<byte, object>();
			dictionary[245] = customEventContent;
			dictionary[244] = eventCode;
		...
		public virtual bool OpRaiseEvent(byte eventCode, System.Collections.Hashtable customEventContent, bool sendReliable)
		{
			return OpRaiseEvent(eventCode, customEventContent, sendReliable, 0);
		}

		public virtual bool OpRaiseEvent(byte eventCode, System.Collections.Hashtable customEventContent, bool sendReliable, byte channelId)
		{
			Dictionary<byte, object> dictionary = new Dictionary<byte, object>();
			dictionary[245] = customEventContent;
			dictionary[244] = eventCode;
		...
		public virtual bool OpRaiseEvent(byte eventCode, System.Collections.Hashtable customEventContent, bool sendReliable, byte channelId, int[] targetActors)
		{
			Dictionary<byte, object> dictionary = new Dictionary<byte, object>();
			dictionary[245] = customEventContent;
			dictionary[244] = eventCode;
		...
		public virtual bool OpRaiseEvent(byte eventCode, System.Collections.Hashtable customEventContent, bool sendReliable, byte channelId, EventCaching cache, ReceiverGroup receivers)
		{
			Dictionary<byte, object> dictionary = new Dictionary<byte, object>();
			dictionary[245] = customEventContent;
			dictionary[244] = eventCode;
		...
		public virtual bool OpSetPropertiesOfActor(int actorNr, System.Collections.Hashtable properties, bool broadcast, byte channelId)
		{
			Dictionary<byte, object> dictionary = new Dictionary<byte, object>();
		...
		public virtual bool OpSetPropertiesOfGame(System.Collections.Hashtable properties, bool broadcast, byte channelId)
		{
			Dictionary<byte, object> dictionary = new Dictionary<byte, object>();
			dictionary.Add(251, properties);
			if (broadcast)
		...
		public virtual bool OpJoin(string gameName, System.Collections.Hashtable gameProperties, System.Collections.Hashtable actorProperties, bool broadcastActorProperties)
		{
			if ((int)base.DebugOut >= 5)
			{
