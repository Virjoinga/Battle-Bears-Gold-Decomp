...
namespace Newtonsoft.Json.Linq
{
	public abstract class JContainer : JToken, IList<JToken>, ICollection<JToken>, IEnumerable<JToken>, ITypedList, IBindingList, IList, ICollection, IEnumerable
	{
		...
		private AddingNewEventHandler m_AddingNew;
		...
		public event AddingNewEventHandler AddingNew
		{
			add
			{
				...
				AddingNewEventHandler val = this.m_AddingNew;
				AddingNewEventHandler val2;
				do
				{
					val2 = val;
					AddingNewEventHandler value2 = (AddingNewEventHandler)Delegate.Combine((Delegate)(object)val2, (Delegate)(object)value);
					val = Interlocked.CompareExchange(ref this.m_AddingNew, value2, val2);
				}
				while (val != val2);
			}
			remove
			{
				...
				{
					val2 = val;
					AddingNewEventHandler value2 = (AddingNewEventHandler)Delegate.Remove((Delegate)(object)val2, (Delegate)(object)value);
					val = Interlocked.CompareExchange(ref this.m_AddingNew, value2, val2);
				}
				while (val != val2);
			}
		...
		protected virtual void OnAddingNew(AddingNewEventArgs e)
		{
			...
			if (addingNew != null)
			{
				addingNew.Invoke((object)this, e);
			}
		}
		...
		object IBindingList.AddNew()
		{
			...
			JToken jToken = (JToken)val.NewObject;
			Add(jToken);
			return jToken;
		}
