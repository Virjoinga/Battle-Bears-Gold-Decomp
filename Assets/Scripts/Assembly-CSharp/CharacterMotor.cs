...
public class CharacterMotor : MonoBehaviour
{
	...
	public class CharacterMotorMovement
	{
		...
		public float maxSidewaysSpeed = 160f;

		public float maxBackwardsSpeed = 160f;
		...
		public float maxGroundAcceleration = 400f;

		public float maxAirAcceleration = 300f;
	...
	public class CharacterMotorSliding
	{
		...
		public float slidingSpeed = 1000f;
	...
	private void Awake()
	{
		...
		tr = base.transform;
		movement.originalGravity = movement.gravity;
	}
	...
	private void UpdateFunction()
	{
		...
		if (!float.IsNaN(motion.x) && !float.IsNaN(motion.y) && !float.IsNaN(motion.z))
		{
			if (playerController != null && !playerController.isRemote && playerController.StatManager != null)
			{
				Vector3 vector2 = new Vector3(motion.x, 0f, motion.z);
				vector2 += playerController.StatManager[Statistic.SpeedModAdditive] * motion.normalized;
				vector2 *= playerController.StatManager[Statistic.SpeedModMult];
				motion = new Vector3(vector2.x, motion.y, vector2.z);
			}
	...
	private Vector3 ApplyInputVelocityChange(Vector3 velocity)
	{
		...
		normalized *= movement.slowdownMultiplier;
