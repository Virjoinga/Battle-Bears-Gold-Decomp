...
[AddComponentMenu("BBR Image Effects/Noise")]
[ExecuteInEditMode]
public class BBRNoise : MonoBehaviour
{
	...
	protected void Start()
	{
		...
		if (shaderRGB == null)
		{
			shaderRGB = (Shader)Resources.Load("ImageEffects/Shaders/NoiseRGB");
		}
		if (shaderYUV == null)
		{
			shaderYUV = (Shader)Resources.Load("ImageEffects/Shaders/NoiseYUV");
		}
		...
		{
			grainTexture = (Texture)Resources.Load("ImageEffects/Textures/NoiseGrain");
		}
		if (scratchTexture == null)
		{
			scratchTexture = (Texture)Resources.Load("ImageEffects/Textures/NoiseScratch");
		}
	}
	...
	private void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		material.SetVector("_ScratchOffsetScale", new Vector4(scratchX + Random.value * scratchJitter, scratchY + Random.value * scratchJitter, (float)Screen.width / ((float)scratchTexture.width * scratchScale), (float)Screen.height / ((float)scratchTexture.height * scratchScale)));
