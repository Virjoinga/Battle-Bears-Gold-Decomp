...
public class RaycastWeapon : WeaponBase
{
	...
	protected int _currentSpawnPointIndex;

	protected Transform _defaultSpawnPoint;

	protected float _maxAngleDifference = 20f;

	protected float _minDistanceToUseCameraDir = 50f;
	...
	protected RaycastTracerPool _pool;

	protected bool showingTracer;

	protected Transform bodyRotator;
	...
	protected virtual void OnHit(DamageReceiver d)
	{
		OnDealDirectDamage(d, damage * base.playerController.DamageMultiplier);
	}
