...
uniform highp vec4 _WeaponColor;
varying highp vec2 xlv_TEXCOORD0;
varying lowp vec3 xlv_TEXCOORD2;
void main ()
{
  ...
  c_3 = tmpvar_4;
  highp vec3 tmpvar_5;
  tmpvar_5 = mix (_WeaponColor.xyz, c_3.xyz, c_3.www);
  tmpvar_2 = tmpvar_5;
...
void main ()
{
  ...
  tmpvar_10 = (max (vec4(0.0, 0.0, 0.0, 0.0), (
    (((tmpvar_6 * tmpvar_4.x) + (tmpvar_7 * tmpvar_4.y)) + (tmpvar_8 * tmpvar_4.z))
   * 
    inversesqrt(tmpvar_9)
  )) * (1.0/((1.0 + 
    (tmpvar_9 * unity_4LightAtten0)
  ))));
  highp vec3 tmpvar_11;
  tmpvar_11 = (((
    (unity_LightColor[0].xyz * tmpvar_10.x)
   + 
    (unity_LightColor[1].xyz * tmpvar_10.y)
  ) + (unity_LightColor[2].xyz * tmpvar_10.z)) + (unity_LightColor[3].xyz * tmpvar_10.w));
  tmpvar_2 = tmpvar_11;
  gl_Position = (glstate_matrix_mvp * _glesVertex);
  xlv_TEXCOORD0 = ((_glesMultiTexCoord0.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
  xlv_TEXCOORD1 = tmpvar_1;
...
void main ()
{
  ...
  highp vec4 tmpvar_6;
  tmpvar_6 = (unity_4LightPosX0 - cse_5.x);
  highp vec4 tmpvar_7;
  tmpvar_7 = (unity_4LightPosY0 - cse_5.y);
  highp vec4 tmpvar_8;
  tmpvar_8 = (unity_4LightPosZ0 - cse_5.z);
  highp vec4 tmpvar_9;
  tmpvar_9 = (((tmpvar_6 * tmpvar_6) + (tmpvar_7 * tmpvar_7)) + (tmpvar_8 * tmpvar_8));
  highp vec4 tmpvar_10;
  tmpvar_10 = (max (vec4(0.0, 0.0, 0.0, 0.0), (
